	...
	const plans: PricingPlan[] = [
		{
			...
			sessions: 1,
			description:
				"Your sixty-minute deep dive: pinpoint your challenge, get clarity and walk away with an actionable next step.",
			expandedDescription:
				"Ideal if you are exploring whether nutritional coaching is right for you, or if you have a specific health question that needs expert guidance.",
			bestFor: [
			...
			relatedServices: [
				{
					name: "Chronic Digestive Problems",
					href: "/service/chronic-digestive-problems",
				},
				{
					name: "Blood Pressure Balance",
					href: "/service/blood-pressure-balance",
				},
				{
					name: "Menopause Health Coaching",
					href: "/service/menopause-health-coaching",
				},
			],
		},
		{
			...
			sessions: 3,
			description:
				"Get momentum: start building healthier habits with structure and direction.",
			expandedDescription:
				"Perfect for starting to build sustainable health habits. Enough time to see initial changes and develop a foundation for lasting transformation.",
			savings: 15,
			bestFor: [
			...
			relatedServices: [
				...
				{
					name: "UTI & Pelvic Health",
					href: "/service/uti-pelvic-health",
				},
		...
		},
		{
			...
			sessions: 6,
			description:
				"Sustain your progress. Ideal if you are ready to commit to meaningful change.",
			expandedDescription:
				"The sweet spot for sustainable transformation. Enough sessions to address complex health issues, build lasting habits, and see real, measurable results.",
			savings: 60,
			bestFor: [
		...
		},
		{
			...
			sessions: 12,
			description:
				"Transform your lifestyle and mindset with lasting results, not just quick fixes.",
			expandedDescription:
				"The complete transformation experience. Deep work over three months to create fundamental shifts in your health, habits, and relationship with food and your body.",
			savings: 180,
			highlighted: true,
			bestFor: [
			...
			relatedServices: [
				{
					name: "All Health Coaching Services",
					href: "/service/chronic-digestive-problems",
				},
			],
		},
...
<section
	class="py-20 bg-gradient-to-br from-white via-warm-white to-sage-light/10"
>
	<div class="container-custom">
		<div class="text-center mb-16">
			...
			<p class="text-xl text-gray-600 max-w-3xl mx-auto">
				Serving Hamilton, Burlington, Ancaster, and surrounding areas.
				Choose your level of support here's exactly what you get with
				each plan, step by step.
			</p>
		</div>
		...
		<div class="max-w-4xl mx-auto mb-12">
			<div
				class="bg-gradient-to-br from-green-50 to-sage-light/30 border-2 border-green-200 rounded-2xl p-8 text-center"
			>
				<div
				...
				<p class="text-lg text-gray-700 mb-4 max-w-2xl mx-auto">
					Before committing to any plan, chat with us for 15 minutes
					via WhatsApp (video optional). Discuss your health goals,
					ask questions, and find out which plan is right for you.
				</p>
				<p class="text-gray-600">
					No pressure. No obligation. Just honest conversation about
					your health.
				</p>
			</div>
		</div>
				...
				>
					...
					>
						<div class="p-8 md:p-12">
							<!-- Title & Price -->
							<div
								class="flex flex-col md:flex-row md:items-start md:justify-between gap-6 mb-8 pb-8 border-b border-gray-200"
							>
								<div class="flex-1">
									<h3
										class="text-3xl md:text-4xl font-bold text-charcoal mb-3"
									>
										{plan.name}
									</h3>
									{#if plan.savings}
										<div
											class=" text-primary font-semibold text-sm mb-4"
										>
											Save ${plan.savings} compared to single
											sessions
										</div>
									{/if}
								...
								<div
									class="text-center md:text-right flex-shrink-0"
								>
									<div
										class="inline-block bg-gradient-to-br from-primary/10 to-secondary/10 rounded-2xl p-6 border border-primary/20"
									>
										<div
										...
										<div
											class="mt-3 text-sm text-gray-700 font-medium"
										>
											{plan.sessions} session{plan.sessions >
											1
												? "s"
												: ""} included
										</div>
							...
							<div class="mb-8">
								<h4
									class="text-xl font-bold text-charcoal mb-4 flex items-center gap-2"
								>
							...
							<div class="mb-8">
								<h4
									class="text-xl font-bold text-charcoal mb-6 flex items-center gap-2"
								>
								...
								<div class="space-y-6">
									{#each plan.whatToExpect as step, stepIndex}
										<div
											class="relative pl-8 border-l-4 {stepIndex ===
											plan.whatToExpect.length - 1
												? 'border-accent/30'
												: 'border-accent/50'} pb-6"
										>
											<div
												class="absolute -left-3 top-0 w-6 h-6 rounded-full bg-accent border-4 border-white shadow-md"
											></div>
											{#if step.week}
												<div
													class="text-xs font-bold text-accent uppercase tracking-wide mb-1"
												>
													{step.week}
												</div>
											{/if}
											<h5
												class="text-lg font-bold text-charcoal mb-3"
											>
												{step.title}
											</h5>
											<ul class="space-y-2">
							...
							<!-- Related Services -->
							<div
								class="bg-gradient-to-br from-sage-light/20 to-warm-white rounded-xl p-6 border border-sage/20"
							>
								<h4
									class="text-lg font-bold text-charcoal mb-4"
								>
		...
		<div class="text-center mt-16">
			...
			<WhatsappButton
				message="Hi! I'd like to discuss Health Coaching options."
				variant="secondary"
			/>
			<p class="text-gray-600 mt-6 max-w-xl mx-auto">
				Start with a free 15-minute consultation via WhatsApp. Not sure
				which plan is right for you? Let's chat whether you're in
				Hamilton, Burlington, or the surrounding area, I'll help you
				choose the best option for your goals and situation.
			</p>
		</div>
	</div>
</section>
