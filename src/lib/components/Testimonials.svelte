...
<section
	id="testimonials"
	class="section-padding bg-warm-white relative overflow-hidden"
>
	<!-- Background decoration -->
	<div
		class="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-primary/5 rounded-full blur-3xl"
	></div>
	...
	<div class="container-custom relative z-10">
		...
		<div class="text-center max-w-3xl mx-auto mb-24 space-y-4">
			...
			<p class="text-xl text-gray-600 leading-relaxed font-light">
				...
				say about their health transformation journey.
			</p>
		</div>
		...
		{#if testimonials.length > 0}
			<div class="max-w-5xl mx-auto mb-12">
				...
				>
					<!-- Decorative gradient -->
					<div
						class="absolute top-0 left-0 right-0 h-2 bg-gradient-to-r from-primary via-secondary to-accent"
					></div>
					...
					<div class="relative z-10 p-12 md:p-16">
						<div class="space-y-8">
							...
							<!-- Quote -->
							<blockquote
								class="text-lg text-charcoal font-medium leading-relaxed"
							>
							...
							<div class="flex justify-center">
								<div
									class="w-16 h-1 bg-gradient-to-r from-transparent via-primary to-transparent"
								></div>
							</div>
							...
							<div class="flex flex-col items-center gap-4">
								...
								<div class="relative">
									...
									{:else}
										<div
											class="w-20 h-20 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white text-2xl font-bold shadow-lg"
										>
									...
									<!-- Verification badge -->
									<div
										class="absolute -bottom-1 -right-1 w-8 h-8 bg-green-500 rounded-full flex items-center justify-center shadow-lg"
									>
										<svg
								...
								<div class="text-center space-y-1">
									<div
										class="font-bold text-xl text-charcoal"
									>
										{testimonials[0].name}
									</div>
									...
									<div
										class="inline-flex items-center gap-2 bg-primary/10 px-4 py-1.5 rounded-full mt-2"
									>
										<span
				...
				{#each testimonials.slice(1, 5) as testimonial, index (testimonial.id)}
					...
					>
						<div class="space-y-4">
							...
							<!-- Quote -->
							<p
								class="text-gray-700 leading-relaxed text-sm line-clamp-4"
							>
								"{testimonial.quote}"
							</p>
							...
							<!-- Author -->
							<div
								class="flex items-center gap-3 pt-2 border-t border-gray-200"
							>
								...
								{:else}
									<div
										class="w-10 h-10 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white text-sm font-bold"
									>
								...
								<div>
									<div
										class="font-semibold text-sm text-charcoal"
									>
										{testimonial.name}
									</div>
					...
					<div class="flex items-center gap-6">
						...
						<div>
							<div class="flex items-center gap-2 mb-2">
								<span class="text-4xl font-bold text-charcoal"
									>{googleRating}</span
								>
