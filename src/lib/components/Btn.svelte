...
<button
  class="btn group relative inline-flex items-center gap-1 overflow-hidden rounded-xl bg-white/80 px-4 py-2 text-sm font-semibold text-black duration-300 hover:bg-white"
>
  <!-- Text Glitch  -->
