...
>
	...
	<div
		class="absolute top-0 right-0 w-96 h-96 bg-sage-light/10 rounded-full blur-3xl -z-10"
	></div>
	<div
		class="absolute bottom-0 left-0 w-96 h-96 bg-rose/10 rounded-full blur-3xl -z-10"
	></div>
	...
	<div class="container-custom">
		...
		<div class="mb-24">
			<header class="text-center">
				...
				<div class="text-center mb-12 mt-4">
					...
					>
						Health Coaching That Helps You <span
							class="text-primary block"
							>Feel Like Yourself Again</span
						>
					</h2>
			...
			<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
				{#each healthCoachingServices.slice(0, 6) as service, index}
					{@const IconComponent =
						iconMap[service.cardIcon] || Activity}
					{@const colorClass = service.cardColor === 'primary'
						? 'text-primary'
						: service.cardColor === 'secondary'
						? 'text-secondary'
						: 'text-accent'}
					<a
						href="/service/{service.slug}"
						class="card-premium group relative bg-white rounded-3xl p-8 hover-premium transition-all duration-300"
					...
					>
						...
						<div class="mb-6 relative">
							...
							>
								<IconComponent class={colorClass} size={32} aria-hidden="true" />
							</div>
						</div>
		...
		<div class="mb-20">
			<header class="text-center">
				...
				<div class="text-center mb-12 mt-4">
					<h2
						class="text-4xl md:text-5xl lg:text-6xl font-bold text-charcoal leading-tight tracking-tight"
					>
						<span class="text-primary block">Feel Comfortable</span
						>in Your Skin Again
					</h2>
					<p class="text-xl text-gray-600 leading-relaxed font-light">
						Professional, safe, and effective skin treatments
					</p>
				</div>
			</header>
			...
			<div class="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
				{#each skinTreatmentServices as service, index}
					{@const IconComponent =
						iconMap[service.cardIcon] || Sparkles}
					<a
						href="/service/{service.slug}"
					...
					>
						...
						<div class="space-y-4">
							<h3
								class="text-xl font-bold text-charcoal group-hover:text-primary transition-colors"
							>
								{service.service}
							</h3>
		...
		<div class=" mx-auto">
			<div
				class="relative bg-primary rounded-3xl overflow-hidden shadow-2xl"
			>
				<!-- Decorative elements -->
				<div
				...
				<div class="relative z-10 p-12 md:p-16 text-center">
					<div class="space-y-6">
						...
						<p
							class="text-white/90 text-lg max-w-2xl mx-auto leading-relaxed"
						>
							Book a free 15-minute consultation and we'll help
							determine the best path forward for your health
							goals. No commitment required.
						</p>
						...
						<div class="pt-4">
							...
							<!-- Trust indicators -->
							<div
								class="flex items-center justify-center gap-8 pt-8 text-white/80 text-sm"
							>
								...
								<div
									class="hidden sm:block h-4 w-px bg-white/30"
								></div>
								<div class="flex items-center gap-2">
									<svg
										class="w-5 h-5"
