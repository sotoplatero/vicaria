<script lang="ts">
	import { Activity, Heart, Users, Droplets, Sparkles, ArrowRight, Search } from '@lucide/svelte';
	...
	const medicalBusinessSchema = {
		...
		description: 'Expert nutrition counseling, health coaching, and professional skin treatments in Hamilton, Ontario. Specialized care for digestive health, diabetes, cancer support, menopause, and skin concerns.',
...
<svelte:head>
	<title>Professional Health Coaching & Skin Treatment Services in Hamilton, ON | Vicaria Health</title>
	<meta name="description" content="Expert nutrition counseling, health coaching, and professional skin treatments in Hamilton. Specialized care for digestive health, diabetes, cancer recovery, menopause, skin tags, milia removal, and more. Book your free consultation today." />
	<meta name="keywords" content="health coaching Hamilton, nutrition counseling Hamilton, dietitian Hamilton, skin treatment Hamilton, diabetes coach, digestive health, menopause support, skin tag removal, milia removal Hamilton" />

	<!-- Open Graph / Social Media -->
	<meta property="og:title" content="Professional Health Coaching & Skin Treatment Services | Vicaria Health" />
	<meta property="og:description" content="Expert nutrition counseling, health coaching, and professional skin treatments in Hamilton. Specialized care for digestive health, diabetes, cancer recovery, and skin concerns." />
	...
	<meta name="twitter:title" content="Professional Health Coaching & Skin Treatment Services | Vicaria Health" />
	<meta name="twitter:description" content="Expert nutrition counseling and skin treatments in Hamilton, Ontario." />
...
<main class="pt-16">
	<!-- Hero Section -->
	<section class="relative min-h-[60vh] flex items-center overflow-hidden bg-gradient-to-br from-warm-white to-white">
		<!-- Decorative Elements -->
		...
		<div class="container-custom relative z-10 py-20">
			<div class="max-w-4xl mx-auto text-center space-y-8">
				...
				<!-- Title -->
				<h1 class="text-4xl md:text-6xl lg:text-7xl font-bold text-charcoal leading-[0.95] tracking-tight">
					Professional Health Coaching & <span class="text-primary block">Skin Treatment Services</span> in Hamilton
				</h1>

				<!-- Description -->
				<p class="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
					Expert nutrition counseling, personalized health coaching, and professional skin treatments to help you feel like yourself again.
				</p>

				<!-- CTA -->
				<div class="pt-4">
					<WhatsAppButton text="Free 15-Min Consultation" variant="secondary" size="xl" />
				</div>

				<!-- Trust Indicators -->
				<div class="flex flex-wrap items-center justify-center gap-6 pt-6 text-sm text-gray-600">
		...
		<div class="container-custom">
			<header class="text-center mb-16">
				<div class="inline-flex items-center justify-center gap-2 glass px-5 py-2.5 rounded-full shadow-sm mb-6">
					...
					<span class="text-sm font-medium text-primary">Health Coaching</span>
				</div>
				<h2 class="text-4xl md:text-5xl lg:text-6xl font-bold text-charcoal leading-tight tracking-tight mb-4">
					Personalized Nutrition & <span class="text-primary">Wellness Coaching</span>
				</h2>
				<p class="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
					Evidence-based nutrition counseling tailored to your unique health needs and goals.
				</p>
			</header>

			<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
				{#each healthCoachingServices as service, index}
					{@const IconComponent = iconMap[service.cardIcon.toLowerCase()] || Activity}
					<article
					...
					>
						...
						<div class="space-y-4">
							...
							<!-- Solution -->
							<div class="pt-2 pb-4">
								<blockquote class="text-sm text-gray-700 leading-relaxed italic border-l-2 border-primary pl-4">
									{service.solution}
								</blockquote>
							</div>
		...
		<div class="container-custom">
			<header class="text-center mb-16">
				<div class="inline-flex items-center justify-center gap-2 glass px-5 py-2.5 rounded-full shadow-sm mb-6">
					...
					<span class="text-sm font-medium text-secondary">Skin Treatments</span>
				</div>
				<h2 class="text-4xl md:text-5xl lg:text-6xl font-bold text-charcoal leading-tight tracking-tight mb-4">
					Professional <span class="text-secondary">Skin Treatment</span> Services
				</h2>
				<p class="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
					Safe, effective, and professional treatments for common skin concerns.
				</p>
			</header>

			<div class="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
				{#each skinTreatmentServices as service, index}
					{@const IconComponent = iconMap[service.cardIcon.toLowerCase()] || Sparkles}
					<article
					...
					>
						...
						<!-- Content -->
						<div class="space-y-4">
							<h3 class="text-xl font-bold text-charcoal group-hover:text-secondary transition-colors">
								{service.service}
							</h3>
			...
			<div class="relative bg-primary rounded-3xl overflow-hidden shadow-2xl">
				...
				<div class="relative z-10 p-12 md:p-16 text-center">
					<div class="space-y-6">
						...
						<!-- Trust indicators -->
						<div class="flex flex-wrap items-center justify-center gap-8 pt-8 text-white/80 text-sm">
							<div class="flex items-center gap-2">
